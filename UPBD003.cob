...
000030*    プログラム名  ： 取次ファイル作成処理
000040*    プログラムＩＤ： UPBD003
000050*    作  成  者    ： T.HARUYAMA
000060*    作  成  日    ： 2003年12月12日
000070*    修  正  日    ： 2004年01月29日  種別区分追加
000080****************************************************************
000090 IDENTIFICATION                    DIVISION.
000100 PROGRAM-ID.                       UPBD003.
...
000250 FILE-CONTROL.
000260*------------ファイル   （入力）-------------------------------*
000270     SELECT  UEU723I ASSIGN     TO  UEU723I
000280                      STATUS    IS  FILE-STATUS.
000290*------------ファイル   （出力）-------------------------------*
000300     SELECT  UPT703O ASSIGN
000310                                TO  UPT703O
...
000390*            ファイル   （入力）
000400****************************************************************
000410 FD  UEU723I        LABEL  RECORD STANDARD.
000420 01  UEU723I-REC.
000430     COPY   UEU723C.
000440*
000450****************************************************************
000460*            ファイル   （出力）
000470****************************************************************
000480 FD  UPT703O         LABEL  RECORD STANDARD.
000490 01  UPT703O-REC.
000500     COPY   UPT703C.
000510*
...
002400               MOVE  UEU723-SYUPPAN-CD9  TO  NEW-KEY-SYUPPAN
002410         ELSE
...
002800     INITIALIZE  UPT703O-REC.
002810****************************************************************
002820*    ここは、入力ファイルから
002830*    OUTPUT用ファイルへの編集を記述すること。
002840****************************************************************
002850     MOVE    UEU723-TOR-CD9
002860         TO  UPT703-TORIHIKI-CD9.
002870     MOVE    UEU723-SYUPPAN-CD9
002880         TO  UPT703-SYUPPAN-CD9.
002890     MOVE    2
002900         TO  UPT703-SYU-KBN9.
002910     MOVE    X"0A"
002920         TO  UPT703-KAI-CD.
002930*
002940 EDIT-EXT.
002950     EXIT.
002960****************************************************************
...
003840*
003850     CLOSE     UEU723I.
003860     CLOSE     UPT703O.
