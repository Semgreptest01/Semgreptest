...
000030*    プログラム名  ： 即売ファイル作成(取引_銘柄)処理
000040*    プログラムＩＤ： UPBD007
000050*    作  成  者    ： T.HARUYAMA
000060*    作  成  日    ： 2004年03月 5日
000070*    修  正  日    ： 
000080****************************************************************
000090 IDENTIFICATION                    DIVISION.
000100 PROGRAM-ID.                       UPBD007.
...
000250 FILE-CONTROL.
000260*------------ファイル   （入力）-------------------------------*
000270     SELECT  UPT711I ASSIGN     TO  UPT711I
000280                      STATUS     IS  FILE-STATUS.
000290*------------ファイル   （出力）-------------------------------*
000300     SELECT  UPT713O ASSIGN
000310                                TO  UPT713O
...
000390*            ファイル   （入力）
000400****************************************************************
000410 FD  UPT711I        LABEL  RECORD STANDARD.
000420 01  UPT711I-REC.
000430     COPY   UEU721C.
000440*
000450****************************************************************
000460*            ファイル   （出力）
000470****************************************************************
000480 FD  UPT713O         LABEL  RECORD STANDARD.
000490 01  UPT713O-REC.
000500     COPY   UPT713C.
000510*
...
002400               MOVE  UEU721-SKU-CD9      TO  NEW-KEY-SKU
002410         ELSE
...
002800     INITIALIZE  UPT713O-REC.
002810****************************************************************
002820*    ここは、入力ファイルから
002830*    OUTPUT用ファイルへの編集を記述すること。
002840****************************************************************
002850     MOVE    UEU721-TOR-CD9
002860         TO  UPT713-TORIHIKI-CD9.
002870     MOVE    UEU721-SKU-CD9
002880         TO  UPT713-SKU-CD9.
002910     MOVE    X"0A"
002920         TO  UPT713-KAI-CD.
002930*
002940 EDIT-EXT.
002950     EXIT.
002960****************************************************************
...
003840*
003850     CLOSE     UPT711I.
003860     CLOSE     UPT713O.
