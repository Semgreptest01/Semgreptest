...
000030*    プログラム名  ： 取次ファイル作成(取引_銘柄)処理
000040*    プログラムＩＤ： UPBD009
000050*    作  成  者    ： T.HARUYAMA
000060*    作  成  日    ： 2004年03月04日
000070*    修  正  日    ： 
000080****************************************************************
000090 IDENTIFICATION                    DIVISION.
000100 PROGRAM-ID.                       UPBD009.
...
000250 FILE-CONTROL.
000260*------------ファイル   （入力）-------------------------------*
000270     SELECT  UPT715I ASSIGN     TO  UPT715I
000280                      STATUS    IS  FILE-STATUS.
000290*------------ファイル   （出力）-------------------------------*
000300     SELECT  UPT717O ASSIGN
000310                                TO  UPT717O
...
000390*            ファイル   （入力）
000400****************************************************************
000410 FD  UPT715I        LABEL  RECORD STANDARD.
000420 01  UPT715I-REC.
000430     COPY   UEU723C.
000440*
000450****************************************************************
000460*            ファイル   （出力）
000470****************************************************************
000480 FD  UPT717O         LABEL  RECORD STANDARD.
000490 01  UPT717O-REC.
000500     COPY   UPT717C.
000510*
...
000740       05  NEW-KEY-MEIGARA             PIC 9(06) VALUE ZERO.
000750     03  OLD-KEY.
000760       05  OLD-KEY-TORIHIKI            PIC 9(06) VALUE ZERO.
000770       05  OLD-KEY-MEIGARA             PIC 9(06) VALUE ZERO.
000780*
000790*---------------< ステータスの定義 >--------------------------*
000800 01  STATUS-AREA.
000810     03  FILE-STATUS                   PIC X(02) VALUE ZERO.
000820*---------------< カウントの定義 >----------------------------*
000830 01  UPT715-CNT-AREA.
...
002390               MOVE  UEU723-TOR-CD9      TO  NEW-KEY-TORIHIKI
002400               MOVE  UEU723-MEIGARA-CD9  TO  NEW-KEY-MEIGARA
002410         ELSE
...
002800     INITIALIZE  UPT717O-REC.
002810****************************************************************
002820*    ここは、入力ファイルから
002830*    OUTPUT用ファイルへの編集を記述すること。
002840****************************************************************
002850     MOVE    UEU723-TOR-CD9
002860         TO  UPT717-TORIHIKI-CD9.
002870     MOVE    UEU723-MEIGARA-CD9
002880         TO  UPT717-MEIGARA-CD9.
002910     MOVE    X"0A"
002920         TO  UPT717-KAI-CD.
002930*
002940 EDIT-EXT.
002950     EXIT.
002960****************************************************************
...
003840*
003850     CLOSE     UPT715I.
003860     CLOSE     UPT717O.
