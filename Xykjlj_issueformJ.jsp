...
<%
	//フォームデータ解析
	Xykjlj_ISSUEFORM param = new Xykjlj_ISSUEFORM(request);
...
// *---------------------------------------------------------------------
// * システム　　名称 : ＭＳＩ　システム
// * 画面名称		  : 共通・ＤＲ−ＳＶ検索・画面（Xykjlj_issueformJ.jsp）
// * 会社名or所属名   : ＣＶＳシステム事業部
...
// ＳＶ配列
var Array_issueform =  new Array(
<%=param.createIssueformJS()%>
);
// ****************
// *** 初期処理 ***
// ****************
function initial() {
	...
	opener.Array_issueform = Array_issueform;
	opener.pop_issueform(opener.form1);
	top.close();
}
// -->
</SCRIPT>
