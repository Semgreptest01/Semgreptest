...
<%
	//フォームデータ解析
	Xykjlj_NewsProduct param = new Xykjlj_NewsProduct(request);
...
// *---------------------------------------------------------------------
// * システム　　名称 : ＭＳＩ　システム
// * 画面名称		  : 共通・ＤＲ−ＳＶ検索・画面（Xykjlj_productJ.jsp）
// * 会社名or所属名   : ＣＶＳシステム事業部
// * 作成日 		  : 2003/04/16 12:00:00
// * 作成者 		  : 
// * *** 修正履歴 ***
// * No.  Date		  Aouther	   Description
// * 01   2006/06/08  O.Ogawara    pageParameters処理追加(コネクションクローズ対応)
// *---------------------------------------------------------------------
-->
<STYLE TYPE="text/css">
<!--
