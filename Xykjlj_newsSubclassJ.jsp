...
<%
	//フォームデータ解析
	Xykjlj_NewsSUBCLASS param = new Xykjlj_NewsSUBCLASS(request);
...
// *---------------------------------------------------------------------
// * システム　　名称 : ＭＳＩ　システム
// * 画面名称		  : 共通・ＤＲ−ＳＶ検索・画面（Xykjlj_subclassJ.jsp）
// * 会社名or所属名   : ＣＶＳシステム事業部
...
// ＳＶ配列
var Array_subclass =  new Array(
<%=param.createSubclassJS()%>
);
// ****************
// *** 初期処理 ***
// ****************
function initial() {
	...
	opener.Array_subclass = Array_subclass;
	opener.pop_subclass(opener.form1);
	top.close();
}
// -->
</SCRIPT>
