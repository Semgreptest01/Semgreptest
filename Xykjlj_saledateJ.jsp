...
<%
    //フォームデータ解析
    Xykjlj_SALEDATE param = new Xykjlj_SALEDATE(request);
...
// *---------------------------------------------------------------------
// * システム　　名称 : ＭＳＩ　システム
// * 画面名称         : 共通・ＤＲ−ＳＶ検索・画面（Xykjlj_saledateJ.jsp）
// * 会社名or所属名   : ＣＶＳシステム事業部
...
// ＳＶ配列
var Array_saledate =  new Array(
<%=param.createSaledateJS()%>
);
// ****************
// *** 初期処理 ***
// ****************
function initial() {
    ...
    opener.Array_saledate = Array_saledate;
    opener.pop_saledate(opener.form1);
    top.close();
    // add start koga 2004/06/09
    opener.button_sts_chg();
    // add end koga 2004/06/09
}
// -->
</SCRIPT>
</HEAD>
