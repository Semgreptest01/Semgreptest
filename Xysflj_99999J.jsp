...
<TABLE width="690" cellpadding="0" cellspacing="0"><TBODY><TR valign="top"><TD align="left">
<TEXTAREA rows="30" cols="105" id="msg_out" style="color:red;background:#F0FFFFfont-size=8pt;overflow:auto;"
 readonly>
