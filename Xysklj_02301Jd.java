 ...
 * (ダウンロード)用クラス
 */
public class Xysklj_02301Jd extends HttpServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
		...
		//フォームデータ解析
		Xysklj_02301_Params param = null;

		try {
			param = new Xysklj_02301_Params(req);
...
// 2006/05/12変更(E10K移行対応)
		...
		// ***** ﾛｸﾞ出力処理  END  ****************************************************************************
			...
			// CSVファイルを出力
//			csvDownload(res, "Xysk2301.csv", csv1,csv2,csv3, getLineSeparator());
			csvDownload(res, "Xysk2301.csv", csv1,csv2,csv3, getLineSeparator(),detailTable.renewday);
	...
	public static boolean csvDownload(HttpServletResponse response,
		...
		try{																		// try
			...
			if ( renewday != null && !renewday.equals("") ){
				out.print(",,新聞社　商品(全国)別実績" + kaigyo_cd );
			}
