...
#----------------------------------------------------------------------#
# ｓｈｅｌｌ−ｉｄ: supbd1032
# ｓｈｅｌｌ名    : supbd1032.csh
# 機能            : WEB連携KEYﾃﾞｰﾀ(SUBCLASS)   コード変換   
# 作成者          : K.Nasu  
# 作成日          : 2001/03/01
# 修正履歴        :
#    1  2003/06/20  M.Saitou   /prod/jcl/msisub -> /prod/jcl/sub
#                              コード変換 bcut -> mdport へ変更
#    2  2003/06/24  M.Saitou   upw298p.euc -> upw298p.sjs
...
# <COUNTCHK PARM SET>
#
set MB_FILE  = $WKDIR03/upw298p.mbx
set HDR_FILE = $WKDIR02/upw298p.chk
set DAT_FILE = $WKDIR01/upw298p.dat
#
#----------------------------------------------------------------------#
# メイン部
#----------------------------------------------------------------------#
...
#
#E10K BEF#set MDPORTF_IN  = "$WKDIR01/upw298p.dat"
set CONV_IN  = "$WKDIR01/upw298p.dat"
#E10K BEF#set I_RECFM     = "f"
set I_CODE      = "euc"
#E10K BEF#set MDPORTF_OUT = "$WKDIR01/upw298p.sjs"
set CONV_OUT = "$WKDIR01/upw298p.sjs"
#E10K BEF#set O_RECFM     = "f"
set O_CODE      = "sjis"
#E10K BEF#set FORMATF     = "$CTLDIR/upw298p.ctl"
set FORMATF     = "${CODE_CTLDIR}/upw298p.fmt"
set I_RECDLM    = lf
set O_RECDLM    = lf
#------------------------------------------------------------------------#
#      文字コード変換
