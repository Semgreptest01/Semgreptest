...
#----------------------------------------------------------------------#
# ｓｈｅｌｌ−ｉｄ: supbd1052
# ｓｈｅｌｌ名    : supbd1052.csh
# 機能            : WEB連携KEYﾃﾞｰﾀ(出版社)   コード変換   
# 作成者          : K.Nasu  
# 作成日          : 2001/03/01
# 修正履歴        :
#    1  2003/06/20  M.Saitou   /prod/jcl/msisub -> /prod/jcl/sub
#                              コード変換 bcut -> mdport へ変更
#    2  2003/06/24  M.Saitou   upw287p.euc -> upw287p.sjs
...
# <COUNTCHK PARM SET>
#
set MB_FILE  = $WKDIR03/upw287p.mbx
set HDR_FILE = $WKDIR02/upw287p.chk
set DAT_FILE = $WKDIR01/upw287p.dat
#
#----------------------------------------------------------------------#
# メイン部
#----------------------------------------------------------------------#
...
#
#E10K BEF#set MDPORTF_IN  = "$WKDIR01/upw287p.dat"
set CONV_IN  = "$WKDIR01/upw287p.dat"
#E10K BEF#set I_RECFM     = "f"
set I_CODE      = "ibm"
#E10K BEF#set MDPORTF_OUT = "$WKDIR01/upw287p.sjs"
set CONV_OUT = "$WKDIR01/upw287p.sjs"
