...
#------------------------------------------------------------------------#
# Shell-id     : supbd2001
# Shell-名     : supbd2001.csh
# 機能         : メニューサービス区分(取引先)更新処理（県刊行別実績バッチ開始）
#                wtzzom003.sql
#                  PARM1:メニュー単位
#                  PARM2:サービス区分
#                        '00':サービス中
...
#------------------------------------------------------------------------#
#E10K BEF#set SQL_PARM=(-s $ORAUID/$ORAPWD @$SQLDIR/wtzzom003.sql 'XY_XYSK1803' '02')
set SQL_PARM=(-s $ORAUID/$ORAPWD @${PLSQLDIR}/wtzzom003.sql 'XY_XYSK1803' '02')
#
...
#------------------------------------------------------------------------#
#E10K BEF#set SQL_PARM=(-s $ORAUID/$ORAPWD @$SQLDIR/wtzzom003.sql 'XY_XYSK1804' '02')
set SQL_PARM=(-s $ORAUID/$ORAPWD @${PLSQLDIR}/wtzzom003.sql 'XY_XYSK1804' '02')
#
# ORACLE TABLE SMM_メニュー単位@XXXX
#
source $SUBSRCDIR/execsql.src
