...
#------------------------------------------------------------------------#
# Shell-id     : supbd2010
# Shell-名     : supbd2010.csh
# 機能         : メニューサービス区分(取引先)更新処理（新聞競馬新聞実績オンライン立ち上げ）
#                wtzzom003.sql
#                  PARM1:メニュー単位
#                  PARM2:サービス区分
#                        '00':サービス中
...
#
#------------------------------------------------------------------------#
#       wtzzom003.sql （220 新聞社−発行形態）
#------------------------------------------------------------------------#
#E10K BEF#set SQL_PARM=(-s $ORAUID/$ORAPWD @$SQLDIR/wtzzom003.sql 'XY_XYSK1805' '00')
set SQL_PARM=(-s $ORAUID/$ORAPWD @${PLSQLDIR}/wtzzom003.sql 'XY_XYSK1805' '00')
#
...
#------------------------------------------------------------------------#
#E10K BEF#set SQL_PARM=(-s $ORAUID/$ORAPWD @$SQLDIR/wtzzom003.sql 'XY_XYSK1806' '00')
set SQL_PARM=(-s $ORAUID/$ORAPWD @${PLSQLDIR}/wtzzom003.sql 'XY_XYSK1806' '00')
#
# ORACLE TABLE SMM_メニュー単位@XXXX
#
source $SUBSRCDIR/execsql.src
