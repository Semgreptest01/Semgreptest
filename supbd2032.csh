...
#----------------------------------------------------------------------#
# ｓｈｅｌｌ−ｉｄ: supbd2032
# ｓｈｅｌｌ名    : supbd2032.csh
# 機能            : WEB連携KEYﾃﾞｰﾀ(SUBCLASS)コード変換(新聞用)
# 作成者          : T.HARUYAMA
# 作成日          : 2004/01/19
# 修正履歴        :
...
# <COUNTCHK PARM SET>
#
set MB_FILE  = $WKDIR03/upw298p2.mbx
set HDR_FILE = $WKDIR02/upw298p2.chk
set DAT_FILE = $WKDIR01/upw298p2.dat
#
#----------------------------------------------------------------------#
# メイン部
#----------------------------------------------------------------------#
...
#
#E10K BEF#set MDPORTF_IN  = "$WKDIR01/upw298p2.dat"
set CONV_IN  = "$WKDIR01/upw298p2.dat"
#E10K BEF#set I_RECFM     = "f"
set I_CODE      = "euc"
#E10K BEF#set MDPORTF_OUT = "$WKDIR01/upw298p2.sjs"
set CONV_OUT = "$WKDIR01/upw298p2.sjs"
