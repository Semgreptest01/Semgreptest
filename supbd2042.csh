...
#----------------------------------------------------------------------#
# ｓｈｅｌｌ−ｉｄ: supbd2042
# ｓｈｅｌｌ名    : supbd2042.csh
# 機能            : WEB連携KEYﾃﾞｰﾀ(発売日１)コード変換(新聞用)
# 作成者          : T.HARUYAMA
# 作成日          : 2004/01/19
# 修正履歴        :
...
# <COUNTCHK PARM SET>
#
set MB_FILE  = $WKDIR03/upw288p2.mbx
set HDR_FILE = $WKDIR02/upw288p2.chk
set DAT_FILE = $WKDIR01/upw288p2.dat
#
#----------------------------------------------------------------------#
# メイン部
#----------------------------------------------------------------------#
...
#
#E10K BEF#set MDPORTF_IN  = "$WKDIR01/upw288p2.dat"
set CONV_IN  = "$WKDIR01/upw288p2.dat"
#E10K BEF#set I_RECFM     = "f"
set I_CODE      = "euc"
#E10K BEF#set MDPORTF_OUT = "$WKDIR01/upw288p2.sjs"
set CONV_OUT = "$WKDIR01/upw288p2.sjs"
